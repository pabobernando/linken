...
function Home() {
  return (
    <div className='bg-gray-950'>
      <div className="relative z-20 flex flex-col items-center overflow-hidden bg-gray-950">
        <div className="container flex flex-col px-6 py-16 mx-auto sm:flex-row sm:justify-between sm:items-center sm:px-10">
          <div className="flex flex-col text-center sm:text-left sm:w-2/5">
            ...
            <h1 className="flex flex-col text-6xl font-black leading-none text-gray-100 uppercase font-bebas-neue sm:text-8xl">
            ...
            <div class="flex mt-8">
               <Link to='/materi' className='mt-2'> <a href="#" className="px-4 py-2 mr-4 text-gray-100 uppercase bg-cyan-500 border-2 border-transparent rounded-lg text-md hover:bg-cyan-400">
                    Mulai Belajar
                </a>
                </Link>
                <a href="https://medium.com/@pabobernando69" className="px-4 py-2 text-gray-100 uppercase bg-transparent border-2 border-cyan-500 rounded-lg hover:bg-cyan-500 text-md">
                    Dokumentasi
                </a>
            </div>
          </div>
