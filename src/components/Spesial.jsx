...
<div className="flex flex-wrap items-center justify-center gap-8 text-center">
      <div className="w-full px-4 py-4 mt-6 bg-black rounded-lg shadow-lg sm:w-1/2 md:w-1/3 lg:w-1/4 border border-cyan-500">
...
Melangkah di dunia yang tak terlacak.
    ...
    <div className="w-full px-4 py-4 mt-6 bg-black border border-cyan-500 rounded-lg shadow-lg sm:w-1/2 md:w-1/3 lg:w-1/4 dark:bg-gray-800">
        <div className="flex-shrink-0">
            <div className="flex items-center justify-center w-12 h-12 mx-auto text-white rounded-md">
                <img src={Secure} />
            </div>
        ...
        Dalam dunia digital yang tak terduga,
Keamanan adalah prioritas utama,
Rahasia kita tetap aman dan terjaga.
        </p>
    </div>
    <div className="w-full px-4 py-4 mt-6 bg-black border border-cyan-500 rounded-lg shadow-lg sm:w-1/2 md:w-1/3 lg:w-1/4 dark:bg-gray-800">
        <div className="flex-shrink-0">
