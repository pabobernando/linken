...
function StrukturBlockchain() {
  return (
    <>
<section>
    <div className="container p-4 mx-auto bg-gray-950 max-w-7xl sm:p-6 lg:p-8">
            ...
            <div className="w-full px-8 lg:w-1/2">
                <div className="pb-12 mb-12 border-b lg:mb-0 lg:pb-0 lg:border-b-0">
                    ...
                    <div className="w-full md:w-1/3">
                        <button type="button" className="py-2 px-4  bg-gray-950 border border-cyan-500 hover:bg-cyan-700 focus:ring-cyan-500 focus:ring-offset-cyan-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                            See more
                        </button>
                    </div>
                </div>
            ...
            <div className="w-full px-8 lg:w-1/2">
                <ul className="space-y-12">
                    <li className="flex -mx-4">
                        <div className="px-4">
                            <span className="flex items-center justify-center w-16 h-16 mx-auto text-2xl font-bold text-white rounded-full font-heading bg-gray-950 border border-cyan-500">
                                1
                            </span>
                        </div>
                        <div className="px-4">
